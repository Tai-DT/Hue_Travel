...
(uuid_generate_v4(), 'a1111111-1111-1111-1111-111111111111',
 ...
 'sightseeing', 180, 350000, 8, 'Cổng Ngọ Môn, Đại Nội Huế',
 16.4698, 107.5789,
...
(uuid_generate_v4(), 'a1111111-1111-1111-1111-111111111111',
 ...
 'sightseeing', 240, 500000, 6, 'Lăng Khải Định, Huế',
 16.4107, 107.5798,
...
(uuid_generate_v4(), 'a3333333-3333-3333-3333-333333333333',
 ...
 'experience', 150, 280000, 8, 'Bến thuyền Tòa Khâm, Huế',
 16.4620, 107.5850,
...
(uuid_generate_v4(), 'a3333333-3333-3333-3333-333333333333',
 ...
 'experience', 480, 750000, 6, 'Cổng VQG Bạch Mã',
 16.2020, 107.8543,
...
(uuid_generate_v4(), 'a1111111-1111-1111-1111-111111111111',
 ...
 'experience', 120, 450000, 12, 'Bến Thuyền Rồng, Lê Lợi',
 16.4612, 107.5869,
...
(uuid_generate_v4(), 'a2222222-2222-2222-2222-222222222222',
 ...
 'tour', 300, 350000, 8, 'Làng cổ Phước Tích, Phong Điền',
 16.5800, 107.3400,
 ARRAY['https://images.unsplash.com/photo-1472745433479-4556f22e32c2?w=800'],
...
(uuid_generate_v4(), 'Đại Nội Huế', 'Hue Imperial Citadel', 'dai-noi-hue',
 'Kinh thành Huế — Di sản văn hóa thế giới UNESCO', 'sightseeing',
...
(uuid_generate_v4(), 'Chùa Thiên Mụ', 'Thien Mu Pagoda', 'chua-thien-mu',
 'Ngôi chùa cổ 400 năm bên sông Hương, tháp Phước Duyên 7 tầng', 'sightseeing',
...
(uuid_generate_v4(), 'Lăng Khải Định', 'Khai Dinh Tomb', 'lang-khai-dinh',
 'Lăng tẩm kiến trúc Đông-Tây kết hợp độc đáo', 'sightseeing',
...
(uuid_generate_v4(), 'Chợ Đông Ba', 'Dong Ba Market', 'cho-dong-ba',
 'Chợ truyền thống lớn nhất Huế, thiên đường ẩm thực', 'food',
...
(uuid_generate_v4(), 'Cầu Trường Tiền', 'Truong Tien Bridge', 'cau-truong-tien',
 'Biểu tượng Huế, 6 nhịp cầu đèn LED đổi màu đẹp lung linh', 'sightseeing',
...
(uuid_generate_v4(), 'Bún Bò Bà Tuyết', 'Ba Tuyet Bun Bo', 'bun-bo-ba-tuyet',
 'Bún bò Huế nổi tiếng nhất thành phố', 'food',
...
(uuid_generate_v4(), 'Đồi Vọng Cảnh', 'Vong Canh Hill', 'doi-vong-canh',
 'Ngắm toàn cảnh sông Hương và thành phố Huế từ trên cao', 'sightseeing',
